...
VALUES
    (uuid_generate_v4(), 'Dr. João Silva', 'joao.silva@ms-cliente.com', 'joaosilva', 'senha123', '12345678901', '1980-04-01', '11999999999', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (uuid_generate_v4(), 'Enf. Maria Souza', 'maria.souza@ms-cliente.com', 'mariasouza', 'senha123', '12345678902', '1990-07-12', '11888888888', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (uuid_generate_v4(), 'Carlos Lima', 'carlos.lima@ms-cliente.com', 'carloslima', 'senha123', '12345678903', '2000-01-15', '11777777777', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
